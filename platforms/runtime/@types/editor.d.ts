    ...
    export module Editor {
        ...
        export module Panel {
            ...
            export type Options< S, M> = {
                ...
                $?: S;
                /** 
                 * @en Panel built-in function methods that can be called in Messages, Lisreners, lifecycle functions
                 * @zh panel 内置的函数方法，可以在 messages、lisreners、生命周期函数内调用 
                 */
                methods?: M;
                /**
            ...
            export function define<Selector = Record<string, string>, M = Record<string, Function>>(options: Options< Selector, M>): any;
        }
