...
export declare type MaybePromised<T> = T | Promise<T>;
export interface JavaScriptSource {
    readonly code: string;
    readonly map: undefined | SourceMap;
}
export declare type SourceMap = string | RawSourceMap;
export declare type TransformResolver = (specifier: string) => string | undefined;
