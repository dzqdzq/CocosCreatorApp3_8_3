...
function rollupTypes(options) {
    ...
    function createProgram() {
        ...
        const host = typescript_1.default.createCompilerHost(tscOptions);
        host.resolveModuleNames = (moduleNames, importer) => {
            ...
            for (const moduleName of moduleNames) {
                if (options.moduleMap && moduleName in options.moduleMap) {
                    ...
                    const resolvedRes = typescript_1.default.resolveModuleName(moduleName, importer, tscOptions, host);
